        ...
        return (
            <div className="lower">
                ...
                <form id="edit">
                    ...
                    <div>
                        <select onChange={this.handleINAnim.bind(this)} id="animationIN"
                            name="animationIN" placeholder="animationIN">
                    ...
                    <div>
                        <select onChange={this.handleOUTAnim.bind(this)} id="animationOUT"
                             name="animationOUT" placeholder="animationIN">
                    ...
                    <p><button className="btn btn-success" name="submit" type="submit"
