...
import {saveSlots, erase, mediaSelectionChanged, deleteMedia, uploadMedia, fetchMedias} from "../actions/mediaActions";
    ...
    render(){
        return(
            <div>
                ...
                <MediaSlots save={this.saveSlots.bind(this)} erase={this.erase.bind(this)} medias={this.props.medias} ad={this.props.adds.currAdd} campaign={this.props.currentCampaign} />
