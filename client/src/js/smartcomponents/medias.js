...
import {eraseSlots, mediaSelectionChanged, deleteMedia, uploadMedia, fetchMedias} from "../actions/mediaActions";
...
export default class Medias extends React.Component {
    ...
    eraseSlots(){
        this.props.dispatch(eraseSlots());
    }
    ...
    render(){
        return(
            <div>
                ...
                <MediaSlots erase={this.eraseSlots.bind(this)} medias={this.props.medias} ad={this.props.adds.currAdd} campaign={this.props.currentCampaign} />
